...
plot_ordination(pslog, out.wuf.log, color = "age_binned",
  ...
  labs(col = "Binned Age", shape = "Litter")
```
# Pourquoi les tracés s'ordination sont-ils si éloignés de la place ?
...
Tous les microbes dont le rang est inférieur à un certain seuil doivent être liés à 1 
...
Correspondance canonique (CCpnA) : est une approche de l'ordination d'une espèce par table d'enchatillon qui intègre des informations supplémentaires sur les échantillons. 
...
1ere étape : diviser les données en ensembles d'apprentissage et de test
...
On test cette méthode pour tester l'association entre abondance microbienne et âge.
